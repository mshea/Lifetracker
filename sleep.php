...
<input type="hidden" name="sleptwell" value="">
<input type="hidden" name="datetime" value="">
<p><input type="submit" value="Slept Well">
</form>
<form method="post" action="controller.php">
<input type="hidden" name="sleptpoorly" value="">
<input type="hidden" name="datetime" value="">
<p><input type="submit" value="Slept Poorly">
</form>
